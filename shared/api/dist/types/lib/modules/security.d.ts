...
import { AxiosHttpResult, Elements, HttpConfig, AbstractWriteableService } from '@herodotus/core';
declare class SysPermissionService extends AbstractWriteableService<SysPermissionEntity> {
    private static instance;
    private constructor();
    static getInstance(config: HttpConfig): SysPermissionService;
    getBaseAddress(): string;
}
declare class SysRoleService extends AbstractWriteableService<SysRoleEntity> {
    private static instance;
    private constructor();
...
declare class SysUserService extends AbstractWriteableService<SysUserEntity> {
    private static instance;
    private constructor();
...
declare class SysAttributeService extends AbstractWriteableService<SysAttributeEntity> {
    private static instance;
    private constructor();
    static getInstance(config: HttpConfig): SysAttributeService;
    getBaseAddress(): string;
}
declare class SysDefaultRoleService extends AbstractWriteableService<SysDefaultRoleEntity> {
    private static instance;
    private constructor();
    static getInstance(config: HttpConfig): SysDefaultRoleService;
    getBaseAddress(): string;
}
declare class SysElementService extends AbstractWriteableService<SysElementEntity> {
    private static instance;
    private constructor();
...
declare class SysTenantDataSourceService extends AbstractWriteableService<SysTenantDataSourceEntity> {
    private static instance;
    private constructor();
...
declare class SysDictionaryService extends AbstractWriteableService<SysDictionaryEntity> {
    private static instance;
    private constructor();
...
declare class SocialBindingService extends AbstractWriteableService<AccessSourceEntity> {
    private static instance;
    private constructor();
