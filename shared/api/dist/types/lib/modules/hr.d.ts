...
import { AxiosHttpResult, Conditions, Pageable, Page, HttpConfig, AbstractEntityService } from '@herodotus/core';
declare class SysOrganizationService extends AbstractEntityService<SysOrganizationEntity> {
    private static instance;
    private constructor();
    static getInstance(config: HttpConfig): SysOrganizationService;
    getBaseAddress(): string;
}
declare class SysDepartmentService extends AbstractEntityService<SysDepartmentEntity> {
    private static instance;
    private constructor();
    static getInstance(config: HttpConfig): SysDepartmentService;
    getBaseAddress(): string;
}
declare class SysEmployeeService extends AbstractEntityService<SysEmployeeEntity> {
    private static instance;
    private constructor();
 ...
 */
declare class SysEmployeeAllocatableService extends AbstractEntityService<SysEmployeeAllocatable> {
    private static instance;
    private constructor();
