...
let OptionsUtilities$7 = class OptionsUtilities {
  // 静态私有实例引用
...
let RouterUtilities$7 = class RouterUtilities {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
class SignOutUtilities {
  ...
  signOut(isLocal = false) {
    ...
    useCryptoStore$d().$reset();
    RouterUtilities$7.getInstance().toSignIn();
  }
  signOutWithDialog() {
    Swal.fire({
      title: "要走了么?",
...
let OAuth2ApiService$7 = class OAuth2ApiService {
  // 静态私有实例引用
...
let OpenApiService$7 = class OpenApiService {
  // 静态私有实例引用
  static instance = null;
  config = {};
  constructor(config) {
...
let PasskeyApiService$7 = class PasskeyApiService extends Service {
  // 静态私有实例引用
  static instance = null;
  constructor(config) {
    super(config);
...
let SecurityApiResources$7 = class SecurityApiResources {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
const getSystemHeaders = () => {
  ...
  const tenantId = OptionsUtilities$7.getTenantId();
  if (tenantId) {
...
function useEditFinish() {
  ...
  const routeStore = useRouterStore$d();
...
function usePasskey() {
  ...
  const registration = (label) => {
    return new Promise((resolve, reject) => {
      SecurityApiResources$7.getInstance().passkey().fetchWebAuthnRegisterOptions().then((publicKey) => {
        ...
        create(registrationOptions).then((registration2) => {
          ...
          SecurityApiResources$7.getInstance().passkey().webAuthnRegister(request).then(() => {
            resolve(true);
          });
        });
      }).catch(() => {
  ...
  const authenticator = () => {
    return new Promise((resolve, reject) => {
      SecurityApiResources$7.getInstance().passkey().fetchWebAuthnAuthenticateOptions().then((publicKey) => {
...
let OptionsUtilities$6 = class OptionsUtilities22 {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
let RouterUtilities$6 = class RouterUtilities22 {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
let OAuth2ApiService$6 = class OAuth2ApiService22 {
  // 静态私有实例引用
  static instance = null;
  config = {};
  constructor(config) {
...
let OpenApiService$6 = class OpenApiService22 {
  // 静态私有实例引用
  static instance = null;
  config = {};
  constructor(config) {
...
let PasskeyApiService$6 = class PasskeyApiService22 extends Service {
  // 静态私有实例引用
  static instance = null;
  constructor(config) {
    super(config);
...
let SecurityApiResources$6 = class SecurityApiResources22 {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
let OptionsUtilities$5 = class OptionsUtilities2222 {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
let RouterUtilities$5 = class RouterUtilities2222 {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
let OAuth2ApiService$5 = class OAuth2ApiService2222 {
  // 静态私有实例引用
  static instance = null;
  config = {};
  constructor(config) {
...
let OpenApiService$5 = class OpenApiService2222 {
  // 静态私有实例引用
  static instance = null;
  config = {};
  constructor(config) {
...
let PasskeyApiService$5 = class PasskeyApiService2222 extends Service {
  // 静态私有实例引用
  static instance = null;
  constructor(config) {
    super(config);
...
let SecurityApiResources$5 = class SecurityApiResources2222 {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
let OptionsUtilities$4 = class OptionsUtilities222222 {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
let RouterUtilities$4 = class RouterUtilities222222 {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
let OAuth2ApiService$4 = class OAuth2ApiService222222 {
  // 静态私有实例引用
  static instance = null;
  config = {};
  constructor(config) {
...
let OpenApiService$4 = class OpenApiService222222 {
  // 静态私有实例引用
  static instance = null;
  config = {};
  constructor(config) {
...
let PasskeyApiService$4 = class PasskeyApiService222222 extends Service {
  // 静态私有实例引用
  static instance = null;
  constructor(config) {
    super(config);
...
let SecurityApiResources$4 = class SecurityApiResources222222 {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
let OptionsUtilities$3 = class OptionsUtilities22222222 {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
let RouterUtilities$3 = class RouterUtilities22222222 {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
let OAuth2ApiService$3 = class OAuth2ApiService22222222 {
  // 静态私有实例引用
  static instance = null;
  config = {};
  constructor(config) {
...
let OpenApiService$3 = class OpenApiService22222222 {
  // 静态私有实例引用
  static instance = null;
  config = {};
  constructor(config) {
...
let PasskeyApiService$3 = class PasskeyApiService22222222 extends Service {
  // 静态私有实例引用
  static instance = null;
  constructor(config) {
    super(config);
...
let SecurityApiResources$3 = class SecurityApiResources22222222 {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
const useCryptoStore$4 = defineStore("Crypto", {
  ...
  actions: {
    ...
    setKey(key) {
      this.key = SM4Utils.encrypt(key, OptionsUtilities222222222.securityKey());
    },
    getKey() {
      return SM4Utils.decrypt(this.key, OptionsUtilities222222222.securityKey());
    },
    encrypt(content) {
      const key = this.getKey();
      return SM4Utils.encrypt(content, key);
...
defineStore("TabsView", {
  ...
  actions: {
    ...
    isNotExistInStaticRoute(tab) {
      return lodash.findIndex(
        OptionsUtilities222222222.getInstance().getOptions().staticRoutes,
        (item) => item.path === tab.path
      ) === -1;
    },
    isTabNotOpened(tab) {
...
let OptionsUtilities$2 = class OptionsUtilities2222222222 {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
let RouterUtilities$2 = class RouterUtilities2222222222 {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
let OAuth2ApiService$2 = class OAuth2ApiService2222222222 {
  // 静态私有实例引用
  static instance = null;
  config = {};
  constructor(config) {
...
let OpenApiService$2 = class OpenApiService2222222222 {
  // 静态私有实例引用
  static instance = null;
  config = {};
  constructor(config) {
...
let PasskeyApiService$2 = class PasskeyApiService2222222222 extends Service {
  // 静态私有实例引用
  static instance = null;
  constructor(config) {
    super(config);
...
let SecurityApiResources$2 = class SecurityApiResources2222222222 {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
let OptionsUtilities$1 = class OptionsUtilities222222222222 {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
let RouterUtilities$1 = class RouterUtilities222222222222 {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
let OAuth2ApiService$1 = class OAuth2ApiService222222222222 {
  // 静态私有实例引用
  static instance = null;
  config = {};
  constructor(config) {
...
let OpenApiService$1 = class OpenApiService222222222222 {
  // 静态私有实例引用
  static instance = null;
  config = {};
  constructor(config) {
...
let PasskeyApiService$1 = class PasskeyApiService222222222222 extends Service {
  // 静态私有实例引用
  static instance = null;
  constructor(config) {
    super(config);
...
let SecurityApiResources$1 = class SecurityApiResources222222222222 {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
function useSystemTheme() {
  ...
  const systemTheme = shallowRef(ThemeModeEnum$d.DARK);
  ...
  const onThemeChange = () => {
    systemTheme.value = media.matches ? ThemeModeEnum$d.DARK : ThemeModeEnum$d.LIGHT;
  };
  watch(
    () => settings.theme.mode,
    (val) => {
      if (val === ThemeModeEnum$d.SYSTEM) {
        media = getMatchMedia();
...
const initializer = (options) => {
  OptionsUtilities$7.initialize(options);
  RouterUtilities$7.initialize(options.router);
  SecurityApiResources$7.initialize(options.config);
  SignOutUtilities.initialize(options.signOutExtension);
};
export {
  AuthorizationGrantTypeEnum,
  CaptchaCategoryEnum$d as CaptchaCategoryEnum,
  LayoutModeEnum$d as LayoutModeEnum,
  OptionsUtilities$7 as OptionsUtilities,
  RouterUtilities$7 as RouterUtilities,
  SecurityApiResources$7 as SecurityApiResources,
  SignOutUtilities,
  SocialSourceEnum,
  ThemeModeEnum$d as ThemeModeEnum,
  getSystemHeaders,
  initializer,
  useAuthenticationStore$1 as useAuthenticationStore,
  useCryptoStore$d as useCryptoStore,
  useEditFinish,
  usePasskey,
  useRouterStore$d as useRouterStore,
  useSettingsStore,
  useSystemMenu,
  useSystemRoute,
  useSystemTheme,
