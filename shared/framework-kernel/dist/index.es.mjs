...
function useEditFinish() {
  ...
  const routeStore = useRouterStore$2();
...
let OptionsUtilities$1 = class OptionsUtilities2 {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
let RouterUtilities$1 = class RouterUtilities2 {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
let OAuth2ApiService$1 = class OAuth2ApiService2 {
  // 静态私有实例引用
  static instance = null;
  config = {};
  constructor(config) {
...
let OpenApiService$1 = class OpenApiService2 {
  // 静态私有实例引用
  static instance = null;
  config = {};
  constructor(config) {
...
let PasskeyApiService$1 = class PasskeyApiService2 extends Service {
  // 静态私有实例引用
  static instance = null;
  constructor(config) {
    super(config);
...
let SecurityApiResources$1 = class SecurityApiResources2 {
  // 静态私有实例引用
  static _instance = null;
  // 初始化标志
  static _initialized = false;
...
function useSystemTheme() {
  ...
  const systemTheme = shallowRef(ThemeModeEnum$2.DARK);
  ...
  const onThemeChange = () => {
    systemTheme.value = media.matches ? ThemeModeEnum$2.DARK : ThemeModeEnum$2.LIGHT;
  };
  watch(
    () => settings.theme.mode,
    (val) => {
      if (val === ThemeModeEnum$2.SYSTEM) {
        media = getMatchMedia();
...
export {
  AuthorizationGrantTypeEnum,
  CaptchaCategoryEnum$2 as CaptchaCategoryEnum,
  LayoutModeEnum$2 as LayoutModeEnum,
  OptionsUtilities,
  RouterUtilities,
  SecurityApiResources,
  SocialSourceEnum,
  ThemeModeEnum$2 as ThemeModeEnum,
  initializer,
  useAuthenticationStore,
  useCryptoStore$2 as useCryptoStore,
  useEditFinish,
  usePasskey,
  useRouterStore$2 as useRouterStore,
  useSettingsStore,
  useSystemMenu,
  useSystemTheme,
  useTabsViewStore
