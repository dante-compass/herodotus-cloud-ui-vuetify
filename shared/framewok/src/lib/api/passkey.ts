import type { HttpConfig, AxiosHttpResult } from '@herodotus/core';

import type { WebAuthnRegister, WebAuthnAuthenticate } from '@/declarations';

import { Service } from '@herodotus/core';
...
export class PasskeyApiService extends Service {
  ...
  public getPublicKeyCredentialCreationOptions(): Promise<AxiosHttpResult<PublicKeyCredentialCreationOptionsJSON>> {
    return this.getConfig()
      .getHttp()
      .post<PublicKeyCredentialCreationOptionsJSON, string>(this.getPublicKeyCredentialCreationOptionsAddress(), '');
  }
  ...
  public getPublicKeyCredentialRequestOptions(): Promise<AxiosHttpResult<PublicKeyCredentialRequestOptionsJSON>> {
    return this.getConfig()
      .getHttp()
      .post<PublicKeyCredentialRequestOptionsJSON, string>(this.getPublicKeyCredentialRequestOptionsAddress(), '');
  }
