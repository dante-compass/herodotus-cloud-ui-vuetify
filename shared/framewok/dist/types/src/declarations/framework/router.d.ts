import { Router, MatcherLocation, RouteRecordRaw, RouteLocationRaw, RouteRecordNameGeneric, RouteLocationAsRelativeGeneric, RouteLocationAsPathGeneric } from 'vue-router';
