import{s as T,c as C,a as S,b as $}from"./npm-@codemirror-autocomplete-B4Vyz6-v.js";import{d as P}from"./npm-@codemirror-commands-Du5LZi_X.js";import{s as N,H as z,b as L,i as O,L as H,a as x}from"./npm-@codemirror-language-BTFD8dNo.js";import{l as B,s as J}from"./npm-@codemirror-lint-C8SPuIWF.js";import{F as _,E as D,C as M}from"./npm-@codemirror-state-D3bf3G4t.js";import{E as g,t as V,k as G}from"./npm-@codemirror-view-qo0d6jM0.js";import{s as K,k as Y,f as W}from"./npm-lang-feel-CjHAa6Z-.js";import{d as Z}from"./npm-min-dom-COcBrpw0.js";import{c as U}from"./npm-@bpmn-io-feel-lint-DqLrG_J5.js";import{t as p}from"./npm-@lezer-highlight-YY5Sg9D5.js";function f(e){return e.from===e.to}function h(e){return e?e.name==="PathExpression"?!0:h(e.parent):!1}var X=[{name:"not(negand)",description:`<p>Returns the logical negation of the given value.</p>
...
`}];const w=X.map(e=>{const t=e.name.match(/^([\w\s]+)\((.*)\)$/),o=t[1],s=t[2].split(", ").map(a=>`\${${a}}`).join(", ");return T(`${o}(${s})`,{label:e.name,type:"function",info:()=>Z(`<div class="description">${e.description}<div>`),boost:-1})});var Q=e=>{let t=x(e.state).resolve(e.pos,-1),o=t.nextSibling;return f(t)||o&&o.from===e.pos&&f(o)?e.explicit?{from:e.pos,options:w}:null:t.parent&&t.parent.name!=="VariableName"||h(t)?null:{from:t.from,options:w}};const q=_.define();var ee=e=>{const t=e.state.facet(q)[0],o=x(e.state).resolve(e.pos,-1);if(!h(o))return;const n=ne(o),s=o===n?e.pos:o.from,a=y(n,e);let r=t;for(var c=0;c<a.length-1;c++){var u=r.find(i=>i.name===a[c].name);if(!u)return null;if(u.isList!=="optional"&&!!u.isList!==a[c].isList)return;r=u.entries}return r?(r=r.map(i=>({label:i.name,type:"variable",info:i.info,detail:i.detail})),{from:s,options:r}):void 0};function ne(e){for(;e;){if(e.name==="PathExpression")return e;e=e.parent}}function y(e,t){let o=[];for(let n=e.firstChild;n;n=n.nextSibling)n.name==="PathExpression"?o.push(...y(n,t)):n.name==="FilterExpression"?o.push(...te(n,t)):o.push({name:R(n,t),isList:!1});return o}function te(e,t){const o=e.firstChild;if(o.name==="PathExpression"){const n=y(o,t),s=n[n.length-1];return s.isList=!0,n}return[{name:R(o,t),isList:!0}]}function R(e,t){return t.state.sliceDoc(e.from,e.to)}var oe=e=>{const o=e.state.facet(q)[0].map(c=>se(c));let n=x(e.state).resolve(e.pos,-1),s=n.nextSibling;if(f(n)||s&&s.from===e.pos&&f(s))return e.explicit?{from:e.pos,options:o}:null;const r={from:n.from,options:o};return n.parent&&n.parent.name!=="VariableName"||h(n)?null:r};function se(e){return e.type==="function"?ae(e):{label:e.name,type:"variable",info:e.info,detail:e.detail}}function ae(e){const{name:t,info:o,detail:n,params:s=[]}=e,a=s.map(({name:l,type:i},v)=>({name:l||`param ${v+1}`,type:i})),r=`${t}(${a.map(l=>"${"+l.name+"}").join(", ")})`,c=a.map(({name:l,type:i})=>i?`${l}: ${i}`:l).join(", "),u=`${t}(${c})`;return T(r,{label:u,type:"function",info:o,detail:n})}function re(){return[S({override:[oe,Q,$(K.map(e=>({...e,boost:-1}))),ee,...Y]})]}function ie(){return new H(W,[])}var pe=[B(U())];const ce=g.theme({"& .cm-content":{padding:"0px"},"& .cm-line":{padding:"0px"},"&.cm-editor.cm-focused":{outline:"none"},"& .cm-completionInfo":{whiteSpace:"pre-wrap",overflow:"hidden",textOverflow:"ellipsis"},"& .cm-completionInfo > *":{whiteSpace:"normal"},"& .cm-completionInfo ul":{margin:0,paddingLeft:"15px"},"& .cm-completionInfo pre":{marginBottom:0,whiteSpace:"pre-wrap"},"& .cm-completionInfo p":{marginTop:0},"& .cm-completionInfo p:not(:last-of-type)":{marginBottom:0}}),le=g.baseTheme({"& .variableName":{color:"#10f"},"& .number":{color:"#164"},"& .string":{color:"#a11"},"& .bool":{color:"#219"},"& .function":{color:"#aa3731",fontWeight:"bold"},"& .control":{color:"#708"}}),ue=N(z.define([{tag:p.variableName,class:"variableName"},{tag:p.name,class:"variableName"},{tag:p.number,class:"number"},{tag:p.string,class:"string"},{tag:p.bool,class:"bool"},{tag:p.function(p.variableName),class:"function"},{tag:p.function(p.special(p.variableName)),class:"function"},{tag:p.controlKeyword,class:"control"},{tag:p.operatorKeyword,class:"control"}]));var ge=[ce,le,ue];const k=new M;function b({extensions:e=[],container:t,contentAttributes:o={},tooltipContainer:n,onChange:s=()=>{},onKeyDown:a=()=>{},onLint:r=()=>{},readOnly:c=!1,value:u="",variables:l=[]}){const i=g.updateListener.of(m=>{m.docChanged&&s(m.state.doc.toString())}),v=g.updateListener.of(m=>{const F=m.transactions.flatMap(d=>d.effects).filter(d=>d.is(J));if(!F.length)return;const I=F.flatMap(d=>d.value);r(I)}),A=g.domEventHandlers({keydown:a});typeof n=="string"&&(n=document.querySelector(n));const j=n?V({tooltipSpace:function(){return n.getBoundingClientRect()}}):[],E=[k.of(q.of(l)),re(),L(),i,C(),g.contentAttributes.of(o),O(),A,G.of([...P]),ie(),pe,v,j,ge,...e];return c&&E.push(g.editable.of(!1)),this._cmEditor=new g({state:D.create({doc:u,extensions:E}),parent:t}),this}b.prototype.setValue=function(e){this._cmEditor.dispatch({changes:{from:0,to:this._cmEditor.state.doc.length,insert:e}})};b.prototype.focus=function(e){const t=this._cmEditor;if(t.contentDOM.focus(),t.focus(),typeof e=="number"){const o=t.state.doc.length;t.dispatch({selection:{anchor:e<=o?e:o}})}};b.prototype.getSelection=function(){return this._cmEditor.state.selection};b.prototype.setVariables=function(e){this._cmEditor.dispatch({effects:k.reconfigure(q.of(e))})};export{b as F};
