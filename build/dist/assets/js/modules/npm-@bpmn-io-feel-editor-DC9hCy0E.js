import{a as _,c as D,s as V}from"./npm-@codemirror-autocomplete-Dq293IPK.js";import{d as M}from"./npm-@codemirror-commands-BpDiG74F.js";import{s as U,H as G,b as K,i as Y,a as R}from"./npm-@codemirror-language-D-SpguUD.js";import{l as W,s as Z}from"./npm-@codemirror-lint-DPrciK6e.js";import{F as q,C as T,E as X}from"./npm-@codemirror-state-BPFAGklU.js";import{E as u,t as Q,k as ee,p as k}from"./npm-@codemirror-view-oMadr2iH.js";import{c as ne}from"./npm-@bpmn-io-feel-lint-Csg3cgCv.js";import{t as p}from"./npm-@lezer-highlight-CQlLGvia.js";import{f as te,s as oe,k as se,a as ae}from"./npm-lang-feel-D6c27nSv.js";import{d as re}from"./npm-min-dom-CeSAYf2p.js";var ie=[W(ne())];const pe=u.theme({"& .cm-content":{padding:"0px"},"& .cm-line":{padding:"0px"},"&.cm-editor.cm-focused":{outline:"none"},"& .cm-completionInfo":{whiteSpace:"pre-wrap",overflow:"hidden",textOverflow:"ellipsis"},"&.cm-editor":{height:"100%"},"& .cm-completionInfo > *":{whiteSpace:"normal"},"& .cm-completionInfo ul":{margin:0,paddingLeft:"15px"},"& .cm-completionInfo pre":{marginBottom:0,whiteSpace:"pre-wrap"},"& .cm-completionInfo p":{marginTop:0},"& .cm-completionInfo p:not(:last-of-type)":{marginBottom:0}}),ce=u.baseTheme({"& .variableName":{color:"#10f"},"& .number":{color:"#164"},"& .string":{color:"#a11"},"& .bool":{color:"#219"},"& .function":{color:"#aa3731",fontWeight:"bold"},"& .control":{color:"#708"}}),le=U(G.define([{tag:p.variableName,class:"variableName"},{tag:p.name,class:"variableName"},{tag:p.number,class:"number"},{tag:p.string,class:"string"},{tag:p.bool,class:"bool"},{tag:p.function(p.variableName),class:"function"},{tag:p.function(p.special(p.variableName)),class:"function"},{tag:p.controlKeyword,class:"control"},{tag:p.operatorKeyword,class:"control"}]));var ue=[pe,ce,le];function F(e){return e&&e.from===e.to}function ge(e,n){const t=e.nextSibling;return F(e)||t&&t.from===n&&F(t)}function de(e){return e&&e.parent&&e.parent.name==="VariableName"}function x(e){return e?e.name==="PathExpression"?!0:x(e.parent):!1}function me({variables:e}){return n=>{const t=R(n.state).resolve(n.pos,-1);if(!x(t))return;const o=fe(t),r=t===o?n.pos:t.from,s=v(o,n);let a=e;for(var c=0;c<s.length-1;c++){var l=a.find(i=>i.name===s[c].name);if(!l)return null;if(l.isList!=="optional"&&!!l.isList!==s[c].isList)return;a=l.entries}return a?(a=a.map(i=>({label:i.name,type:"variable",info:i.info,detail:i.detail})),{from:r,options:a}):void 0}}function fe(e){for(;e;){if(e.name==="PathExpression")return e;e=e.parent}}function v(e,n){let t=[];for(let o=e.firstChild;o;o=o.nextSibling)o.name==="PathExpression"?t.push(...v(o,n)):o.name==="FilterExpression"?t.push(...he(o,n)):t.push({name:A(o,n),isList:!1});return t}function he(e,n){const t=e.firstChild;if(t.name==="PathExpression"){const o=v(t,n),r=o[o.length-1];return r.isList=!0,o}return[{name:A(t,n),isList:!0}]}function A(e,n){return n.state.sliceDoc(e.from,e.to)}function qe({variables:e=[],builtins:n=[]}){const t=be(e,n);return t.length?o=>{const{pos:r,state:s}=o,a=R(s).resolve(r,-1);return ge(a,r)?o.explicit?{from:r,options:t}:null:!de(a)||x(a)?null:{from:a.from,options:t}}:o=>null}function be(e,n){return[].concat(e.map(t=>w(t)),n.map(t=>w(t)))}function w(e,n){return e.type==="function"?xe(e,n):{label:e.name,type:"variable",info:e.info,detail:e.detail,boost:n}}function xe(e,n){const{name:t,info:o,detail:r,params:s=[]}=e,a=s.map(({name:i,type:g},b)=>({name:i||`param ${b+1}`,type:g})),c=`${t}(${a.map(i=>"${"+i.name+"}").join(", ")})`,l=a.map(({name:i,type:g})=>g?`${i}: ${g}`:i).join(", "),f=`${t}(${l})`;return V(c,{label:f,type:"function",info:o,detail:r,boost:n})}function ve({variables:e=[],builtins:n=[]}){return[me({variables:e}),qe({variables:e,builtins:n}),oe(ae.map(t=>({...t,boost:-1}))),...se]}function ye(e){return te(e)}function Ee(e){return e.slice().reverse().reduce((n,t)=>(n[t.name]=()=>{},n),{})}const C=q.define(),j=q.define(),I=q.define(),S=q.define();function P({dialect:e="expression",parserDialect:n,variables:t=[],builtins:o=[],completions:r=ve({builtins:o,variables:t})}){const s=Ee([...t,...o]);return[I.of(e),C.of(o),j.of(t),S.of(n),ye({dialect:e,parserDialect:n,context:s,completions:r})]}function Fe(e){const n=e.facet(C)[0],t=e.facet(j)[0],o=e.facet(I)[0],r=e.facet(S)[0];return{builtins:n,variables:t,dialect:o,parserDialect:r}}var we=[{name:"not(negand)",description:`<p>Returns the logical negation of the given value.</p>
...
`}];function Re(e){return e.map(Te)}function Te(e){const{name:n,description:t}=e,o=n.match(/^([\w\s]+)\((.*)\)$/),r=o[1],s=o[2],a=s?s.split(", ").map(c=>({name:c})):[];return{name:r,type:"function",params:a,info:()=>re(`<div class="description">${t}<div>`),boost:0}}const ke=Re(we),z=new T,$=new T;function m({extensions:e=[],dialect:n="expression",parserDialect:t,container:o,contentAttributes:r={},tooltipContainer:s,onChange:a=()=>{},onKeyDown:c=()=>{},onLint:l=()=>{},placeholder:f="",readOnly:i=!1,value:g="",builtins:b=ke,variables:O=[]}){const B=u.updateListener.of(h=>{h.docChanged&&a(h.state.doc.toString())}),L=u.updateListener.of(h=>{const E=h.transactions.flatMap(d=>d.effects).filter(d=>d.is(Z));if(!E.length)return;const J=E.flatMap(d=>d.value);l(J)}),H=u.domEventHandlers({keydown:c});typeof s=="string"&&(s=document.querySelector(s));const N=s?Q({tooltipSpace:function(){return s.getBoundingClientRect()}}):[],y=[_(),z.of(P({dialect:n,builtins:b,variables:O,parserDialect:t})),K(),Y(),D(),u.contentAttributes.of(r),B,H,ee.of([...M]),ie,L,N,$.of(k(f)),ue,...e];return i&&y.push(u.editable.of(!1)),this._cmEditor=new u({state:X.create({doc:g,extensions:y}),parent:o}),this}m.prototype.setValue=function(e){this._cmEditor.dispatch({changes:{from:0,to:this._cmEditor.state.doc.length,insert:e}})};m.prototype.focus=function(e){const n=this._cmEditor;if(n.contentDOM.focus(),n.focus(),typeof e=="number"){const t=n.state.doc.length;n.dispatch({selection:{anchor:e<=t?e:t}})}};m.prototype.getSelection=function(){return this._cmEditor.state.selection};m.prototype.setVariables=function(e){const n=Fe(this._cmEditor.state);this._cmEditor.dispatch({effects:[z.reconfigure(P({...n,variables:e}))]})};m.prototype.setPlaceholder=function(e){this._cmEditor.dispatch({effects:$.reconfigure(k(e))})};export{m as F};
