import{s as T,c as N,a as z,b as L}from"./npm-@codemirror-autocomplete-BMVmJPTA.js";import{d as O}from"./npm-@codemirror-commands-BGvEtZRZ.js";import{s as H,H as B,b as _,i as J,L as D,a as x}from"./npm-@codemirror-language-CranV552.js";import{l as M,s as V}from"./npm-@codemirror-lint-DKlFSPiL.js";import{F as G,E as K,C as R}from"./npm-@codemirror-state-D3bf3G4t.js";import{E as g,t as Y,k as W,p as k}from"./npm-@codemirror-view-CkRvWC1K.js";import{s as Z,k as U,f as X}from"./npm-lang-feel-DXCJOQEu.js";import{d as Q}from"./npm-min-dom-Bq-NsQKJ.js";import{c as ee}from"./npm-@bpmn-io-feel-lint-DUlxbezR.js";import{t as p}from"./npm-@lezer-highlight-YY5Sg9D5.js";function h(e){return e.from===e.to}function q(e){return e?e.name==="PathExpression"?!0:q(e.parent):!1}var ne=[{name:"not(negand)",description:`<p>Returns the logical negation of the given value.</p>
...
`}];const w=ne.map(e=>{const t=e.name.match(/^([\w\s]+)\((.*)\)$/),o=t[1],s=t[2].split(", ").map(a=>`\${${a}}`).join(", ");return T(`${o}(${s})`,{label:e.name,type:"function",info:()=>Q(`<div class="description">${e.description}<div>`),boost:-1})});var te=e=>{let t=x(e.state).resolve(e.pos,-1),o=t.nextSibling;return h(t)||o&&o.from===e.pos&&h(o)?e.explicit?{from:e.pos,options:w}:null:t.parent&&t.parent.name!=="VariableName"||q(t)?null:{from:t.from,options:w}};const b=G.define();var oe=e=>{const t=e.state.facet(b)[0],o=x(e.state).resolve(e.pos,-1);if(!q(o))return;const n=se(o),s=o===n?e.pos:o.from,a=y(n,e);let r=t;for(var c=0;c<a.length-1;c++){var u=r.find(i=>i.name===a[c].name);if(!u)return null;if(u.isList!=="optional"&&!!u.isList!==a[c].isList)return;r=u.entries}return r?(r=r.map(i=>({label:i.name,type:"variable",info:i.info,detail:i.detail})),{from:s,options:r}):void 0};function se(e){for(;e;){if(e.name==="PathExpression")return e;e=e.parent}}function y(e,t){let o=[];for(let n=e.firstChild;n;n=n.nextSibling)n.name==="PathExpression"?o.push(...y(n,t)):n.name==="FilterExpression"?o.push(...ae(n,t)):o.push({name:A(n,t),isList:!1});return o}function ae(e,t){const o=e.firstChild;if(o.name==="PathExpression"){const n=y(o,t),s=n[n.length-1];return s.isList=!0,n}return[{name:A(o,t),isList:!0}]}function A(e,t){return t.state.sliceDoc(e.from,e.to)}var re=e=>{const o=e.state.facet(b)[0].map(c=>ie(c));let n=x(e.state).resolve(e.pos,-1),s=n.nextSibling;if(h(n)||s&&s.from===e.pos&&h(s))return e.explicit?{from:e.pos,options:o}:null;const r={from:n.from,options:o};return n.parent&&n.parent.name!=="VariableName"||q(n)?null:r};function ie(e){return e.type==="function"?pe(e):{label:e.name,type:"variable",info:e.info,detail:e.detail}}function pe(e){const{name:t,info:o,detail:n,params:s=[]}=e,a=s.map(({name:l,type:i},v)=>({name:l||`param ${v+1}`,type:i})),r=`${t}(${a.map(l=>"${"+l.name+"}").join(", ")})`,c=a.map(({name:l,type:i})=>i?`${l}: ${i}`:l).join(", "),u=`${t}(${c})`;return T(r,{label:u,type:"function",info:o,detail:n})}function ce(){return[z({override:[re,te,L(Z.map(e=>({...e,boost:-1}))),oe,...U]})]}function le(){return new D(X,[])}var ue=[M(ee())];const ge=g.theme({"& .cm-content":{padding:"0px"},"& .cm-line":{padding:"0px"},"&.cm-editor.cm-focused":{outline:"none"},"& .cm-completionInfo":{whiteSpace:"pre-wrap",overflow:"hidden",textOverflow:"ellipsis"},"& .cm-completionInfo > *":{whiteSpace:"normal"},"& .cm-completionInfo ul":{margin:0,paddingLeft:"15px"},"& .cm-completionInfo pre":{marginBottom:0,whiteSpace:"pre-wrap"},"& .cm-completionInfo p":{marginTop:0},"& .cm-completionInfo p:not(:last-of-type)":{marginBottom:0}}),de=g.baseTheme({"& .variableName":{color:"#10f"},"& .number":{color:"#164"},"& .string":{color:"#a11"},"& .bool":{color:"#219"},"& .function":{color:"#aa3731",fontWeight:"bold"},"& .control":{color:"#708"}}),me=H(B.define([{tag:p.variableName,class:"variableName"},{tag:p.name,class:"variableName"},{tag:p.number,class:"number"},{tag:p.string,class:"string"},{tag:p.bool,class:"bool"},{tag:p.function(p.variableName),class:"function"},{tag:p.function(p.special(p.variableName)),class:"function"},{tag:p.controlKeyword,class:"control"},{tag:p.operatorKeyword,class:"control"}]));var fe=[ge,de,me];const j=new R,I=new R;function m({extensions:e=[],container:t,contentAttributes:o={},tooltipContainer:n,onChange:s=()=>{},onKeyDown:a=()=>{},onLint:r=()=>{},placeholder:c="",readOnly:u=!1,value:l="",variables:i=[]}){const v=g.updateListener.of(f=>{f.docChanged&&s(f.state.doc.toString())}),C=g.updateListener.of(f=>{const F=f.transactions.flatMap(d=>d.effects).filter(d=>d.is(V));if(!F.length)return;const P=F.flatMap(d=>d.value);r(P)}),S=g.domEventHandlers({keydown:a});typeof n=="string"&&(n=document.querySelector(n));const $=n?Y({tooltipSpace:function(){return n.getBoundingClientRect()}}):[],E=[j.of(b.of(i)),ce(),_(),v,N(),g.contentAttributes.of(o),J(),S,W.of([...O]),le(),ue,C,I.of(k(c)),$,fe,...e];return u&&E.push(g.editable.of(!1)),this._cmEditor=new g({state:K.create({doc:l,extensions:E}),parent:t}),this}m.prototype.setValue=function(e){this._cmEditor.dispatch({changes:{from:0,to:this._cmEditor.state.doc.length,insert:e}})};m.prototype.focus=function(e){const t=this._cmEditor;if(t.contentDOM.focus(),t.focus(),typeof e=="number"){const o=t.state.doc.length;t.dispatch({selection:{anchor:e<=o?e:o}})}};m.prototype.getSelection=function(){return this._cmEditor.state.selection};m.prototype.setVariables=function(e){this._cmEditor.dispatch({effects:j.reconfigure(b.of(e))})};m.prototype.setPlaceholder=function(e){this._cmEditor.dispatch({effects:I.reconfigure(k(e))})};export{m as F};
