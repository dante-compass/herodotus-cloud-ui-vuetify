import{a as N,c as _,s as D}from"./npm-@codemirror-autocomplete-DFEofn8z.js";import{d as J}from"./npm-@codemirror-commands-CDz53Z8v.js";import{s as V,H as M,b as U,i as G,a as R}from"./npm-@codemirror-language-Bns5VqiP.js";import{l as K,s as Y}from"./npm-@codemirror-lint-CGxQyUJp.js";import{F as b,C as T,E as W}from"./npm-@codemirror-state-C2HDJwGP.js";import{E as u,t as Z,k as X,p as k}from"./npm-@codemirror-view-BBqa7Uzi.js";import{c as Q}from"./npm-@bpmn-io-feel-lint-DoyCXJf0.js";import{t as p}from"./npm-@lezer-highlight-CQlLGvia.js";import{f as ee,s as ne,k as te,a as oe}from"./npm-lang-feel-ijZvRloJ.js";import{d as se}from"./npm-min-dom-CeSAYf2p.js";var ae=[K(Q())];const re=u.theme({"& .cm-content":{padding:"0px"},"& .cm-line":{padding:"0px"},"&.cm-editor.cm-focused":{outline:"none"},"& .cm-completionInfo":{whiteSpace:"pre-wrap",overflow:"hidden",textOverflow:"ellipsis"},"&.cm-editor":{height:"100%"},"& .cm-completionInfo > *":{whiteSpace:"normal"},"& .cm-completionInfo ul":{margin:0,paddingLeft:"15px"},"& .cm-completionInfo pre":{marginBottom:0,whiteSpace:"pre-wrap"},"& .cm-completionInfo p":{marginTop:0},"& .cm-completionInfo p:not(:last-of-type)":{marginBottom:0}}),ie=u.baseTheme({"& .variableName":{color:"#10f"},"& .number":{color:"#164"},"& .string":{color:"#a11"},"& .bool":{color:"#219"},"& .function":{color:"#aa3731",fontWeight:"bold"},"& .control":{color:"#708"}}),pe=V(M.define([{tag:p.variableName,class:"variableName"},{tag:p.name,class:"variableName"},{tag:p.number,class:"number"},{tag:p.string,class:"string"},{tag:p.bool,class:"bool"},{tag:p.function(p.variableName),class:"function"},{tag:p.function(p.special(p.variableName)),class:"function"},{tag:p.controlKeyword,class:"control"},{tag:p.operatorKeyword,class:"control"}]));var ce=[re,ie,pe];function F(e){return e&&e.from===e.to}function le(e,t){const n=e.nextSibling;return F(e)||n&&n.from===t&&F(n)}function ue(e){return e&&e.parent&&e.parent.name==="VariableName"}function x(e){return e?e.name==="PathExpression"?!0:x(e.parent):!1}function ge({variables:e}){return t=>{const n=R(t.state).resolve(t.pos,-1);if(!x(n))return;const o=de(n),s=n===o?t.pos:n.from,i=v(o,t);let a=e;for(var c=0;c<i.length-1;c++){var l=a.find(r=>r.name===i[c].name);if(!l)return null;if(l.isList!=="optional"&&!!l.isList!==i[c].isList)return;a=l.entries}return a?(a=a.map(r=>({label:r.name,type:"variable",info:r.info,detail:r.detail})),{from:s,options:a}):void 0}}function de(e){for(;e;){if(e.name==="PathExpression")return e;e=e.parent}}function v(e,t){let n=[];for(let o=e.firstChild;o;o=o.nextSibling)o.name==="PathExpression"?n.push(...v(o,t)):o.name==="FilterExpression"?n.push(...me(o,t)):n.push({name:A(o,t),isList:!1});return n}function me(e,t){const n=e.firstChild;if(n.name==="PathExpression"){const o=v(n,t),s=o[o.length-1];return s.isList=!0,o}return[{name:A(n,t),isList:!0}]}function A(e,t){return t.state.sliceDoc(e.from,e.to)}function fe({variables:e=[],builtins:t=[]}){const n=he(e,t);return n.length?o=>{const{pos:s,state:i}=o,a=R(i).resolve(s,-1);return le(a,s)?o.explicit?{from:s,options:n}:null:!ue(a)||x(a)?null:{from:a.from,options:n}}:o=>null}function he(e,t){return[].concat(e.map(n=>w(n)),t.map(n=>w(n)))}function w(e,t){return e.type==="function"?qe(e,t):{label:e.name,type:"variable",info:e.info,detail:e.detail,boost:t}}function qe(e,t){const{name:n,info:o,detail:s,params:i=[]}=e,a=i.map(({name:r,type:g},q)=>({name:r||`param ${q+1}`,type:g})),c=`${n}(${a.map(r=>"${"+r.name+"}").join(", ")})`,l=a.map(({name:r,type:g})=>g?`${r}: ${g}`:r).join(", "),f=`${n}(${l})`;return D(c,{label:f,type:"function",info:o,detail:s,boost:t})}function be({variables:e=[],builtins:t=[]}){return[ge({variables:e}),fe({variables:e,builtins:t}),ne(oe.map(n=>({...n,boost:-1}))),...te]}function xe(e){return ee(e)}function ve(e,t){return e.slice().reverse().reduce((n,o)=>(n[o.name]=()=>{},n),{})}const C=b.define(),j=b.define(),I=b.define();function S({dialect:e="expression",variables:t=[],builtins:n=[],completions:o=be({builtins:n,variables:t})}){const s=ve([...t,...n]);return[I.of(e),C.of(n),j.of(t),xe({dialect:e,context:s,completions:o})]}function ye(e){const t=e.facet(C)[0],n=e.facet(j)[0],o=e.facet(I)[0];return{builtins:t,variables:n,dialect:o}}var Ee=[{name:"not(negand)",description:`<p>Returns the logical negation of the given value.</p>
...
// "RkVFTA=="
</code></pre>`}];function Fe(e){return e.map(we)}function we(e){const{name:t,description:n}=e,o=t.match(/^([\w\s]+)\((.*)\)$/),s=o[1],i=o[2],a=i?i.split(", ").map(c=>({name:c})):[];return{name:s,type:"function",params:a,info:()=>se(`<div class="description">${n}<div>`),boost:0}}const Re=Fe(Ee),P=new T,$=new T;function m({extensions:e=[],dialect:t="expression",container:n,contentAttributes:o={},tooltipContainer:s,onChange:i=()=>{},onKeyDown:a=()=>{},onLint:c=()=>{},placeholder:l="",readOnly:f=!1,value:r="",builtins:g=Re,variables:q=[]}){const z=u.updateListener.of(h=>{h.docChanged&&i(h.state.doc.toString())}),O=u.updateListener.of(h=>{const E=h.transactions.flatMap(d=>d.effects).filter(d=>d.is(Y));if(!E.length)return;const H=E.flatMap(d=>d.value);c(H)}),B=u.domEventHandlers({keydown:a});typeof s=="string"&&(s=document.querySelector(s));const L=s?Z({tooltipSpace:function(){return s.getBoundingClientRect()}}):[],y=[N(),P.of(S({dialect:t,builtins:g,variables:q})),U(),G(),_(),u.contentAttributes.of(o),z,B,X.of([...J]),ae,O,L,$.of(k(l)),ce,...e];return f&&y.push(u.editable.of(!1)),this._cmEditor=new u({state:W.create({doc:r,extensions:y}),parent:n}),this}m.prototype.setValue=function(e){this._cmEditor.dispatch({changes:{from:0,to:this._cmEditor.state.doc.length,insert:e}})};m.prototype.focus=function(e){const t=this._cmEditor;if(t.contentDOM.focus(),t.focus(),typeof e=="number"){const n=t.state.doc.length;t.dispatch({selection:{anchor:e<=n?e:n}})}};m.prototype.getSelection=function(){return this._cmEditor.state.selection};m.prototype.setVariables=function(e){const{dialect:t,builtins:n}=ye(this._cmEditor.state);this._cmEditor.dispatch({effects:[P.reconfigure(S({dialect:t,builtins:n,variables:e}))]})};m.prototype.setPlaceholder=function(e){this._cmEditor.dispatch({effects:$.reconfigure(k(e))})};export{m as F};
