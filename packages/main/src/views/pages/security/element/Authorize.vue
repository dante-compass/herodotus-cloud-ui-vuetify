...
import type { SysElementEntity, SysRoleEntity, SysRoleProps, SysRoleConditions } from '@herodotus/api';
import type { VDataTableHeaders } from '@/composables/declarations';

import { useTableItem, useTable } from '@/composables/hooks';
import { API, PAGE_NAME } from '@/configurations';

defineOptions({ name: PAGE_NAME.SYS_ELEMENT_AUTHORIZE });

const { editedItem, overlay, title, assign, onReturn } = useTableItem<SysElementEntity>(
  API.core.sysElement(),
