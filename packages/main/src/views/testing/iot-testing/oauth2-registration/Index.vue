        ...
        <v-card>
          <v-stepper v-model="step" :items="items" show-actions>
            <template #item.1>
              ...
              <h-testing-card title="验证结果：" text="是否能够获取 Access Token">
            ...
            <template #item.2>
              ...
              <h-testing-card title="注册结果" subtitle="新注册客户端的 ClientId 和 ClientSecret">
                <v-text-field v-model="deviceName" label="Device Name(新注册的 Client ID)" disabled></v-text-field>
                <v-text-field
            ...
            <template #item.3>
              ...
              <h-testing-card title="验证结果：" subtitle="是否能够获取 Access Token">
...
defineOptions({
  ...
  components: { HTestingHttpResponse, HTestingHttpResponseLayout, HTestingCard },
});
