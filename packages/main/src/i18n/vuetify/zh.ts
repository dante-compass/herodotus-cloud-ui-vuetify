export const zh = {
  $vuetify: {
    ...
    noDataText: '没有数据',
    carousel: { prev: '上一张', next: '下一张', ariaLabel: { delimiter: '幻灯片 {0} / {1}' } },
    calendar: { moreEvents: '还有 {0} 项', today: '今天' },
    input: {
      clear: '清除 {0}',
    ...
    loading: '加载中...',
    infiniteScroll: { loadMore: '加载更多', empty: '没有更多内容' },
    rules: {
      required: '此字段为必填项',
      email: '请输入有效的电子邮件地址',
      number: '此字段只能包含数字',
